...
cl = LINETCR.LINE()
cl.login(token="ElITYP9AqQbZ1d5CRMPc.skwgztg4SuqUu1exNpTcpa.PQZLkCwWb7KoR4V1SmD5BDa/8d+Fn4j5BapZ9no4hgY=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="ElbSkdcjjduXr4XYJM8c.qpQ1ZgemtxYPk1VkHb2eVa.mYorDzny+bk+WDCFzgx2Uwkj84G9/rf+dpwMwIvejBs=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="ElnUH4Z60ahRw7NUSyO1.8ky1/CNts80QqIUBpMR4iq.DbCBzG2/RayqXDCcDXPa+1y2z8IWjyqjzJnsD80vcEU=)"
ki2.loginResult()
     ...
     for zx in range(0,50):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
            ...
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by K̴̹̳̺̟̃̂͑̿͑̔͌͡ͅĕ̸̡̞͙̲̙̥̥͐̉̆̀v̨̧̛̛͎̺̭̬͈̠̙̉̾̀́͐̍͊̚͜į͉̹͕̳̹̙̙̽̽́̀̐̌̏̊̇n̨̗̥̼̒̀̐͊͐̕͜͠ B̵̺̦̦̫̦͉̳̜͋̃̅̎͒̇̚͞͠ǫ͈̮̼͍̙̰̜̔̀͛̀̐͌͟͡͝t̶̨͓̰̩̎͐̀͑̋̋͢͠\nHttp://line.me/ti/p/~blmdingertiin")
            print "Like"
          except:
            pass
        else:
