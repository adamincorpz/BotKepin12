...
cl = LINETCR.LINE()
cl.login(token="ElX1OuftvUFobHON7wIc.skwgztg4SuqUu1exNpTcpa.bf7Kt7pLLoLsfKipvjzWDr3t1FBqo5/jwzrbWcCJhcU=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="El0q7fRdVqeyvYwYL0Fc.qpQ1ZgemtxYPk1VkHb2eVa.6o4SSuPKh5kueNAFqfxVVZ13QPf5gkuU/EQUSBLRgNg=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="ElrJPxGXcuqnRSoMdGR1.8ky1/CNts80QqIUBpMR4iq.rlDL9AKLB5dWOq16MIQDLmev/tpm6cWiLOm2GkICenA=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="ElFSSFQe6TVIGZTxO705.dC6yiu4IfmwGxy/jNiMXTq.+hQ4TlE07txPKZMDPtsCg+okPbVNbqpWtL/YTzTBlxI=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="El1Pf14Y6FJ6vdw4Qad4.6SyY93ejTT9cMZpnhkaZTa.PNPT/QAgPiyBYCX3lyt2qXJC8wza2Tm7dpVjB2EVGCU=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EluNvNy7MsmuS1DshRN6.HiulzpM2lvbHY7HtFpRuDG.4/+cmzo5VJptOnwPs22fj2GLPV3KE7KvXU0sHly2JWs=")
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token="El4GsXrreKVmfSHSHCp0.SS+xET+afpEmlOpbX9krea.PEtQIA8d5Dkp7oTwbe42gnCJ4ti21DSiTs093/RiWX0=")
ki6.loginResult()

helpMessage ="""       Self Bots Command \n༺ĸ ҉e ҉v ҉ι ҉n ҉ в ҉o ҉т ҉༻
...
☞ http://line.me/ti/p/blmdingertin ☜
"""
helo=""
...
wait = {
   ...
   🛡 http://line.me/ti/p/~blmdingertiin 🛡
""",
    "lang":"JP",
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u48a5866531b8b1442e5351179cfb423c":
                    if "join:" in msg.text:
...
#-------------------Fungsi Spam Start----------------------#
     ...
     #----------------------Fungsi Spam Finish-------------------------------#
                ...
                start = time.time()
                cl.sendText(msg.to, "Ngopi Sejenak...")
...
☆̸ K̴̹̳̺̟̃̂͑̿͑̔͌͡ͅĕ̸̡̞͙̲̙̥̥͐̉̆̀v̨̧̛̛͎̺̭̬͈̠̙̉̾̀́͐̍͊̚͜į͉̹͕̳̹̙̙̽̽́̀̐̌̏̊̇n̨̗̥̼̒̀̐͊͐̕͜͠ B̵̺̦̦̫̦͉̳̜͋̃̅̎͒̇̚͞͠ǫ͈̮̼͍̙̰̜̔̀͛̀̐͌͟͡͝t̶̨͓̰̩̎͐̀͑̋̋͢͠ ☆
...
☆ K̴̹̳̺̟̃̂͑̿͑̔͌͡ͅĕ̸̡̞͙̲̙̥̥͐̉̆̀v̨̧̛̛͎̺̭̬͈̠̙̉̾̀́͐̍͊̚͜į͉̹͕̳̹̙̙̽̽́̀̐̌̏̊̇n̨̗̥̼̒̀̐͊͐̕͜͠ B̵̺̦̦̫̦͉̳̜͋̃̅̎͒̇̚͞͠ǫ͈̮̼͍̙̰̜̔̀͛̀̐͌͟͡͝t̶̴̨̡͓̰̩͈̖̺͖̙̝̩̞̎͐̀͑̋̋͂̏͢͟͠͠L̸̡̩̣̲̣̜̊̑̾̾͊̃͘͜ͅ  ☆
...
#------------------------------------------------------------------------------------
	    ...
	    if op.param2 in Bots:
	        return
	    cl.sendTxt(op.param1,cl.getContact(op.param2).disiplayName + "\nWelcome My Baby Honey\n( ˘ ³˘)❤")
	    print "Member Has Join Grup"
#------------------------------------------------------------------------------------ 
#------------------------------------------------------------------------------------
        if op.type == 19:
            if op.param2 in Bots:
...
def autolike():
     for zx in range(0,50):
	    ...
	    cl.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ༺۝Kevιn๖ۣۜ∂༻\n http://line.me/ti/p/~blmdingertiin")
	    ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ༺۝Kevιn๖ۣۜ∂༻\n http://line.me/ti/p/~blmdingertiin")
	    ki2.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki2.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ༺۝Kevιn๖ۣۜ∂༻\n http://line.me/ti/p/~blmdingertiin")
	    ki3.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki3.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ༺۝Kevιn๖ۣۜ∂༻\n http://line.me/ti/p/~blmdingertiin")
	    ki4.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki4.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ༺۝Kevιn๖ۣۜ∂༻\n http://line.me/ti/p/~blmdingertiin")
	    ki5.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki5.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ༺۝Kevιn๖ۣۜ∂༻\n http://line.me/ti/p/~blmdingertiin")
	    ki6.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki6.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ༺۝Kevιn๖ۣۜ∂༻\n http://line.me/ti/p/~blmdingertiin")
            print "Like"
          except:
            pass
        else:
