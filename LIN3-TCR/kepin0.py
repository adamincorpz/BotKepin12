...
cl = LINETCR.LINE()
cl.login(token="El2nC48i7bREhTYZ8WMc.skwgztg4SuqUu1exNpTcpa.D16pJfiUMUp+3S48hEG1NwDQyL84CQmIEIO+yLOwOp0=")
cl.loginResult()

ki = LIN3TCR.LINE()
ki.login(token="ElwhahaF3HYXqAaMTgFc.qpQ1ZgemtxYPk1VkHb2eVa.VxpYu+J7J5wPcF0s7MprSD2m7irvW0FGVQW7jRLnhU8=")
ki.loginResult()

ki2 = LIN3TCR.LINE()
ki2.login(token="ElsPnwxVWvllCtBXZup0.sOuPUIsvocvWzQLLmuTG4a.OhCeON+Qrn0wnP1h6sk4YVfpcjDS0GeuO3Z5nMJL8/E=")
ki2.loginResult()
...
helpMessage ="""       Self Bots Command ༺ĸ ҉e ҉v ҉ι ҉n ҉ в ҉o ҉т ҉༻
     ...
     for zx in range(0,50):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
            ...
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by : Http://line.me/ti/p!blmdimgertiin")
            print "Like"
          except:
            pass
        else:
