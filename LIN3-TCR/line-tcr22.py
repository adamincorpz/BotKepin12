...
admin=["ua35838bcb43165f7fd749887ef028f5c"]
wait = {
    'contact':True,
    'autoJoin':True,
...
#-------------Fungsi Spam Start---------------------#
		...
		cl.sendText(msg.to,"P")
 		...
 		cl.sendText(msg.to,"P")
                ...
                cl.sendText(msg.to,"P")
#-----------------------------------------------
            elif msg.text in ["Kam","kam","Wc","wc"]:
                ginfo = cl.getGroup(msg.to)
...
#----------------------------------------------                                                                                                                       
                    ...
                    cl.sendText(msg.to,"􂤁􀆋􂜁􀆋􏿿􂜁􀆋􏿿􂜁􀆋􏿿􂜁􀆋􏿿􂜁􀆋􏿿􂜁􀆋􏿿􂜁􀆋􏿿􂜁􀆋􏿿")
                    cl.sendMessage(msg)
                    cl.sendText(msg.to,"􂜁􀆊􏿿􂜁􀆊􏿿􂜁􀆊􏿿􂜁􀆊􏿿􂜁􀆊􏿿􂜁􀆊􏿿􂜁􀆊􏿿􂜁􀆊􏿿")
...
#-----------------------------------------------
                ...
                start = time.time()
                cl.sendText(msg.to, "Sebentar Syng...")
