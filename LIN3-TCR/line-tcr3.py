...
helpMessage =""" K̴̤̠̝͕̞̯͔̖̥̟͂͆̄̆̉̐̽̐̕͠e̶̲̺̲̳̣͕̠̱̥̱̎̍̄̔͆́̔̈́̀͠v̷̧̧͎̲̣͚̼͚̘͚̅̊͛͂͐͑̿͐̕̕i̴̛̩̤̫̲̰̻̠͍͇̭̾͌̓̍̈́̃̓̐͝ņ̷̨̮̥̙͉̳͉̻͉̃̓͋̔̒̃̌̔̓̌ ̶̧̱͖̬͙͇͎͍̳̠̿̔̊̈́̒͂̈́͌̚͠B̵̛̻͖̝̰̥̫͔̠̖̼̔̃̑̒̒͆̍̍͝ǫ̶̘͙̲̞̞̘̲̣̏̊̐͗̅̓̇̈́̿͠ͅẗ̴̢̧̡̜̝͍̤̜͔́̒́̄̚̚̚͝͠͠ͅ
...
Made By : http://line.me/ti/p/~blmdingertiin
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Thanks Add Me Honey",
    "lang":"JP",
    "comment":"Thanks Add Me Honey",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
# ----------------- NOTIFED MEMBER OUT GROUP
        if op.type == 15:
            if op.param2 in Bots:
                return
            kk.sendText(op.param1,cl.getContact(op.param2).displayName + "Good Bye\n(*´･ω･*)")
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                if wait["clock"] == True:
                    ...
                    cl.sendText(msg.to, "Check Pembaca Gelap")
                    try:
...
#-----------Funsi Inv Grup Creator Start---------#
             ...
             if msg.toType == 2:
                 ...
                 try:
                    ...
                    pass
#-----------Fungsi Inv Grup Creator Finish-----# -------------------Fungsi Spam Start----------------------#
     ...
     #----------------------Fungsi Spam Finish-------------------------------#
#-------------Fungsi Spam Start---------------------#
            elif msg.text in ["Up Gan"]:
                cl.sendText(msg.to,"P")
                ki.sendText(msg.to,"P")
                kk.sendText(msg.to,"P")
                cl.sendText(msg.to,"P")
                ki.sendText(msg.to,"P")
                kk.sendText(msg.to,"P")
   	        cl.sendText(msg.to,"P")
...
#----------------------------------------------                                                                                                                       
                   ...
                   if msg.from_ in admin:
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': 'u48a5866531b8b1442e5351179cfb423c'}
                    cl.sendMessage(msg)
